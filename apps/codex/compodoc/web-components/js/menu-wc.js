                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/SpritesheetModule.html" data-type="entity-link" >SpritesheetModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-SpritesheetModule-78b89fa43acfc9d00208e0e12677139a"' : 'data-target="#xs-components-links-module-SpritesheetModule-78b89fa43acfc9d00208e0e12677139a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-SpritesheetModule-78b89fa43acfc9d00208e0e12677139a"' :
                                            'id="xs-components-links-module-SpritesheetModule-78b89fa43acfc9d00208e0e12677139a"' }>
                                            <li class="link">
                                                <a href="components/AnimatedSpritesheetComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >AnimatedSpritesheetComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/LayeredSpritesheetComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >LayeredSpritesheetComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/SpritesheetComponent.html" data-type="entity-link" data-context="sub-entity" data-context-id="modules" >SpritesheetComponent</a>
                                            </li>
                                        </ul>
                                    </li>
                            </li>
