...
export class ApplicationOpenedEvent {
  ...
  constructor(public readonly application: Application, public readonly settings: ApplicationOpenedSettings) { }
}
...
export class ApplicationGroupedEvent {
  ...
  constructor(public readonly application: Application, public readonly group: Application[]) { }
}
