...
export const eraSchema = {
  ...
  required: ['id', 'name', 'shortName', 'startYear', 'military', 'events'],
  type: 'object',
};

export const eraRxSchema: RxJsonSchema<Omit<EraDocType, '_attachments'>> = {
  ...(eraSchema as any),
  title: 'Era',
  description: 'Era',
  version: 0,
...
export const userEraRxSchema: RxJsonSchema<Omit<EraDocType, '_attachments'>> = {
  ...(eraSchema as any),
  title: 'User Era',
